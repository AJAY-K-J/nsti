                ...
                <tbody v-for="user in users" :key="user.id">
                    ...
                    <i class="fa fa-university" title="View Experience Details"></i></button>
                        ...
                        <!--<td>
                         ...
                         <td v-if="(user.certificateVerificationStatus==1)"><span class="badge badge-success">Verified <i class="far fa-check-circle fa-fw"></i></span>
  ...
  <div class="modal-dialog  modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="certificatesView">Certificates Of {{  user_name | upText }}</h5>
...
<img :src="/uploads/+document.document" class="img-fluid rounded" data-toggle="modal" data-target="#expandImageModal" alt="doc images" width="200px" height="200px" @click="singleImageExpand(document)">
      ...
      <div class="modal-footer">
        ...
        <button @click="verifyCertModal()" class="btn btn-success" data-dismiss="modal" >Verify <i class="fa fa-check fa-fw"></i></button>

        <button @click="rejectCertModal()" class="btn btn-danger" data-dismiss="modal">Reject <i class="fa fa-times fa-fw"></i></button>
...
// this.user_candidatePhoto=user.candidatePhoto;
    ...
    verifyCertModal(){
        ...
        axios.post("/certVerify/"+this.userId).then(()=>{
    ...
    loadUsers(){
        axios.get("/TableData").then((data)=>(this.users=data.data));
    },
