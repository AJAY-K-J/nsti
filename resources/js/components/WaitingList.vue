...
<tr>
   ...
   <td v-if="(user_cert_status==1)"><span class="badge badge-success">Verified <i class="far fa-check-circle fa-fw"></i></span>
...
waitingListAction(user){
 ...
 //AdmitStudents
  AdmitStudent(){
    ...
    loadUsers(){
        axios.get("/waitingListStudents").then((data)=>(this.users=data.data));
    },
